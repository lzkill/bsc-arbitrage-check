...
export class TelegramService {
  ...
  async init() {
    if (this.config.telegram.token) {
      this.bot.command('bak_start', async (ctx) => {
        try {
      ...
      this.bot.command('bak_enable', async (ctx) => {
        try {
      ...
      this.bot.command('bak_disable', async (ctx) => {
        try {
      ...
      this.bot.command('bak_config', async (ctx) => {
        try {
      ...
      this.bot.command('bak_ping', async (ctx) => {
        try {
      ...
      this.bot.command('bak_help', async (ctx) => {
        try {
